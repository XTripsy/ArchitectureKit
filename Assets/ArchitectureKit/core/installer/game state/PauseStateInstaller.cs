...
namespace Namespace_StatePause
{
    internal sealed class PauseStateInstaller : IInstaller<IBootstrapContext>
    {
        public void Install(IBootstrapContext installer)
        {
            ...
            int index = input.IGetIndexCatalogInputAction("pause_mapping", group.catalog);
            InputActionMap inputAction = group.action.FindActionMap("pause_mapping", throwIfNotFound: false);
